...
class FirestoreNoteCollection : NoteCollection() {
    ...
    override fun generateNewUUID(newNote: com.ajsnarr.linknotes.data.Note): UUID {
    ...
    override fun add(element: com.ajsnarr.linknotes.data.Note): Boolean {
    ...
    override fun remove(element: com.ajsnarr.linknotes.data.Note): Boolean {
        return super.remove(element).also {
            dao.deleteNote(Note.fromAppObject(element))
        }
    }
    override fun removeAll(elements: Collection<com.ajsnarr.linknotes.data.Note>): Boolean {
        return super.removeAll(elements).also {
            dao.deleteNotes(elements.map { note -> Note.fromAppObject(note) })
        }
    }
    override fun retainAll(elements: Collection<com.ajsnarr.linknotes.data.Note>): Boolean {
