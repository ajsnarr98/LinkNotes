...
class FirestoreTagCollection : TagCollection() {
    ...
    override fun add(element: com.ajsnarr.linknotes.data.Tag): Boolean {
    ...
    override fun remove(element: com.ajsnarr.linknotes.data.Tag): Boolean {
        return this.value.let { masterSet ->
            if (masterSet is TagTreesSet)
                super.remove(element).also {
                    ...
                    if (matchingRoot != null) {
                        ...
                        dao.deleteTagTree(TagTree.fromAppObject(com.ajsnarr.linknotes.data.TagTree.newTreeFrom(element)))
                    }
                }
            else
                throw UnsupportedOperationException("Unknown set type")
    ...
    override fun removeAll(elements: Collection<com.ajsnarr.linknotes.data.Tag>): Boolean {
        return this.value.let { masterSet ->
            if (masterSet is TagTreesSet) {
    ...
    override fun retainAll(elements: Collection<com.ajsnarr.linknotes.data.Tag>): Boolean {
        return this.value.let { masterSet ->
