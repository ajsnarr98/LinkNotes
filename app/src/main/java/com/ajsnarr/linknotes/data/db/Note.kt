...
data class Note(
...
) : DBObject<com.ajsnarr.linknotes.data.Note> {

    companion object {
        fun fromAppObject(other: com.ajsnarr.linknotes.data.Note) : Note {
            return Note(
                id = other.id,
                type = other.type,
                name = other.name,
    ...
    override fun toAppObject(): com.ajsnarr.linknotes.data.Note {
        return com.ajsnarr.linknotes.data.Note(
            id = this.id!!,
            _type = this.type!!,
            _name = this.name!!,
    ...
    private fun toAppEntryList(): com.ajsnarr.linknotes.data.EntryList {
        return com.ajsnarr.linknotes.data.EntryList.fromCollection(
