...
//        return null
    ...
    override suspend fun arePendingChangesForNote(note: Note): ResultStatus<Boolean, ErrorType> {
        TODO("handle updated ResultStatus")
...
//        })
    ...
    override suspend fun saveNote(note: Note): ResultStatus<Note, ErrorType> {
        TODO("handle updated ResultStatus")
//        isLoading.value = true
//        return try {
...
//        }
    ...
    override suspend fun deleteNote(note: Note): ResultStatus<Note, ErrorType> {
        TODO("handle updated ResultStatus")
//        isLoading.value = true
//        return try {
...
//        }
    ...
    override suspend fun containsTag(tag: Tag): ResultStatus<Boolean, ErrorType> {
